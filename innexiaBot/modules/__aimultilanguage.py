...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not Escobar:
            await lel.edit("Alby AI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"Alby AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
...
__help__ = """
<b> Chatbot </b>
Alby AI 3.0 IS THE ONLY AI SYSTEM WHICH CAN DETECT & REPLY UPTO 200 LANGUAGES
